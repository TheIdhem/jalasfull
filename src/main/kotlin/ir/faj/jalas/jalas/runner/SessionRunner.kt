...
class SessionRunner(
    ...
    override fun run(vararg args: String?) {
        ...
        val mehdi = users.save(User(username = "the_idhem", email = "mohammadf00900@gmail.com", name = "mehdi"))
        val golnaz = users.save(User(username = "grrinova", email = "golnaz.a108@gmail.com", name = "golnaz"))
